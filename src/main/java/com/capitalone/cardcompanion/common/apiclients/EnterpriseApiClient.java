 ...
 */
@ThreadSafe
public abstract class EnterpriseApiClient extends RestClient {
     ...
     * Constructor.
     */
    protected EnterpriseApiClient(Class<? extends ContextResolver<ObjectMapper>> classOfObjectMapper) {
        super(RestClientProperties.builder().
                        extraProviderClasses(Collections.<Class<?>>singleton(classOfObjectMapper)).
                        optionalHostnameVerifier(hostnameVerifierFromConfig("enterpriseApiClient.hostnameVerifier.name")).
                        optionalSslContext(sslContextFromConfig("enterpriseApiClient.sslContext")).
                        serviceUrl(Config.getInstance().getString("enterpriseApiClient.baseUrl").get()).
                        build()
        );
    }
    ...
    protected <T, U> Response<U> invoke(final Request<T, U> request) throws RestClientException {
        ...
        if (context != null) {
            ...
            headers.put("enterprise_sso_id",context.getEnterpriseSSOId());
    ...
    protected abstract class PagedIterator<T> implements Iterable<T> {
        ...
        public Iterator<T> iterator() {
            return new Iterator<T>() {
                ...
                private Optional<String> pageKey = Optional.absent();
                ...
                public T next() {
                    ...
                    GetRequest<T> request = pageRequest(pageUri, pageKey);
                    hasNext = false;
                    T t;
                    try {
                    ...
                    Optional<String> pagingKey = getPageKey(t);
        ...
        /**
         * Returns an optional page Key.
         */
        protected abstract Optional<String> getPageKey(T t);


        /**
         * Returns a request to get a page.
         */
        protected abstract GetRequest<T> pageRequest(Optional<URI> pageUri, Optional<String> pageKey);
    }
}
