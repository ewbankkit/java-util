...
import static com.github.ewbankkit.util.DateUtil.dateToString;
import static com.github.ewbankkit.util.DateUtil.stringToDate;
import static com.github.ewbankkit.util.beans.BaseData.lessThan;
...
public final class CalendarUtil {
    ...
    public static String calendarToDateTimeString(Calendar calendar) {
        return DateUtil.dateToDateTimeString(calendarToDate(calendar));
    }
    ...
    public static String calendarToString(Calendar calendar) {
        return DateUtil.dateToString(calendarToDate(calendar));
    }

    public static String calendarToString(Calendar calendar, DateFormat format) {
        return DateUtil.dateToString(calendarToDate(calendar), format);
    }
    ...
    public static Calendar dateTimeStringToCalendar(String string) throws ParseException {
        return dateToCalendar(DateUtil.dateTimeStringToDate(string));
    }
    ...
    public static Calendar stringToCalendar(String string) throws ParseException {
        return dateToCalendar(DateUtil.stringToDate(string));
    }

    public static Calendar stringToCalendar(String string, DateFormat format) throws ParseException {
        return dateToCalendar(DateUtil.stringToDate(string, format));
    }
